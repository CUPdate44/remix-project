...
module.exports = {
  ...
  'Should display compile error in editor': function (browser: NightwatchBrowser) {
    browser.waitForElementVisible('#editorView')
      ...
      .checkAnnotations('fa-exclamation-square', 28) // error
  ...
  'Should highlight source code': function (browser: NightwatchBrowser) {
    ...
    browser
      ...
      .checkElementStyle('.highlightLine33', 'background-color', 'rgb(8, 108, 181)')
      .scrollToLine(40)
      .waitForElementPresent('.highlightLine41', 60000)
      .checkElementStyle('.highlightLine41', 'background-color', 'rgb(8, 108, 181)')
      .scrollToLine(50)
      .waitForElementPresent('.highlightLine51', 60000)
      .checkElementStyle('.highlightLine51', 'background-color', 'rgb(8, 108, 181)')
  },
